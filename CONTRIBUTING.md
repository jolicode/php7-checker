...
1. [Fork it](https://github.com/jolicode/php7-checker/fork_select)
2. improve it
...
php7-checker's coding standards:
...
```shell
git remote add upstream https://github.com/jolicode/php7-checker.git
```
